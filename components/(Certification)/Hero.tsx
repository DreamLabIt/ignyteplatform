...
export default function Hero() {
    return (
        <section
            className="w-full min-h-screen pt-35 sm:pt-62 pb-26 px-6 relative overflow-hidden"
            style={{
        ...
        >
            <div className="max-w-[1620px] mx-auto w-full flex flex-col items-center relative z-10">
                <div className="max-w-262.5 w-full flex flex-col items-center text-center gap-4 ">

                    <div className="inline-flex items-center justify-center bg-[#1E374F] border border-white/10 rounded-[25px] py-1.25 px-3.75">
                        <span className="font-Inter font-medium text-[16px] sm:text-[18px] leading-[100%] text-[#ECEBEC] tracking-wide">
                ...
                <div className="w-full max-w-386.5 h-62.5 sm:h-112.5 md:h-150 lg:h-175 relative mb-20 sm:mb-30 pt-18">
                ...
                <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 pt-70">

                    <div className="w-full lg:max-w-208 flex flex-col items-start">
                        <h2 className="font-Inter font-semibold text-[32px] sm:text-[36px] md:text-[40px] leading-[125%] text-[#1E374F] mb-10 tracking-tight">
                            FedRAMP Authorization Requires Efficient Processes and Expert Guidance
                        </h2>

                        <p className="font-Inter font-medium text-[16px] sm:text-[18px] md:text-[20px] leading-[125%] text-[#1E374F] mb-8">
