...
export default function Hero() {
    return (
        <div
            className="w-full relative pt-70 pb-26 overflow-hidden"
            style={{
            ...
            <section className="w-full relative z-10 px-6 ">
                <div className="mx-auto w-full flex flex-col items-center">
                    ...
                    <div className="w-full flex flex-col items-center text-center">
                        <h1 className="font-Inter font-semibold text-[36px] sm:text-[48px] md:text-[64px] leading-[130%] text-[#3B7CB3] tracking-tight mb-8">
                            Get CMMC Certified <span className="text-[#1E374F]">in Weeks, <br className="hidden sm:inline" /> Not Months</span>
                        </h1>

                        <p className="font-Inter font-medium text-[15px] sm:text-[16px] md:text-[20px] leading-[130%] text-[#4A607A] max-w-212.5 mb-8">
                ...
                <div className="absolute -bottom-2 left-0 right-0 h-[50%] bg-linear-to-t from-[#ebebec] to-transparent pointer-events-none z-10" />
            </section>

            <section className="w-full relative pt-38 z-10 px-6">
                ...
                <div className="max-w-[1640px] mx-auto w-full flex flex-col items-center">
                    ...
                    <div className="w-full text-center mb-12 md:mb-23 max-w-250">
                        <h2 className="font-Inter font-semibold text-[26px] sm:text-[32px] md:text-[40px] leading-[130%] text-[#1E374F] mb-6 tracking-tight">
                            <span className="text-[#3B7CB3]">Don’t Let Compliance Delays</span> Put Your <br className="hidden sm:inline" /> Contracts at Risk
                        </h2>
                        <div className="flex flex-col gap-6 font-Inter font-medium text-[14px] sm:text-[15px] md:text-[18px] leading-[114%] text-[#4A607A] max-w-265 mx-auto">
                            <p>
                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 px-6">
                        {featureData.map((feature, index) => (
                            <div
                                key={index}
                                className="w-full bg-[#92B5D740] backdrop-blur-md border border-[#E2E2E2] rounded-2xl p-8 py-6 flex flex-col items-start transition-all duration-300 hover:bg-[#E3EFFC]"
                            >
                                ...
                                <p className="font-Inter font-semibold text-[14px] sm:text-[20px] leading-[120%] text-[#1E374F]">
                                    {feature.description}
                                </p>
                            </div>
                        ))}
